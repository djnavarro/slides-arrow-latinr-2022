...
## Querying data stored in an S3 bucket
...
This talk isn't meant to be a tutorial but I still think it's a kindness to list some resources!
...
- [blog.djnavarro.net/#category=Apache%20Arrow](https://blog.djnavarro.net/#category=Apache%20Arrow)
