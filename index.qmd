...
# Sydney, Australia {background-image="img/sydney.jpg" background-position="cover"}

Apparently there is a bridge here or something

<!-- image credit: me. I took this photo in 2022 -->

# Voltron Data {background-image="img/voltrondata.png" background-position="cover"}
...
# New York, USA {background-image="img/newyork.jpg" background-position="cover"}
...
La Mezquita-Catedral is an awfully convenient metaphor 
...
# Case study 3: Connecting to an AWS S3 bucket 

# Whyalla, Australia {background-image="img/whyalla.jpg" background-position="cover"}
...
# Case study 4: [Efficiently transferring Arrow data over a network with Arrow Flight]()
